...
'ORIGINAL LINE: this.richEditControl1.CustomMarkDraw += new DevExpress.XtraRichEdit.RichEditCustomMarkDrawEventHandler(this.richEditControl1_CustomMarkDraw);
			' 
			' panelControl1
			' 
...
'INSTANT VB NOTE: The following InitializeComponent event wireup was converted to a 'Handles' clause:
'ORIGINAL LINE: this.btn_Mark.Click += new System.EventHandler(this.btn_Mark_Click);
			' 
			' btn_DeleteMarks
			' 
...
'INSTANT VB NOTE: The following InitializeComponent event wireup was converted to a 'Handles' clause:
'ORIGINAL LINE: this.btn_DeleteMarks.Click += new System.EventHandler(this.btn_DeleteMarks_Click);
			' 
			' Form1
			' 
